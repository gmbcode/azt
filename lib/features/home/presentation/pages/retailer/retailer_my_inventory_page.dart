                              ...
                              Switch(
                                ...
                                onChanged: (val) {
                                  if(val) {
                                    ...
                                    // Logic Check: Passing 0 effectively delists the item
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              // Logic Check: Ensure they don't list more than they have in Reserve (stockremain)
              if (qty <= 0) {
                ...
                // All checks passed - Call the Cubit
